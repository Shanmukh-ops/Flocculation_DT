...
st.sidebar.image("ICCW_01.png", width=200)
...
st.markdown("<h2 style='margin-bottom:0px;'>Digital Twin for Waste Water Treatment Process</h2>", unsafe_allow_html=True)
st.markdown("<h4 style='margin-top:0px; margin-bottom:5px; color:gray;'>Hydraulic Flocculation</h4>", unsafe_allow_html=True)
...
with col3:
    st.subheader("PSD (Inlet vs Outlet)")
    fig, ax = plt.subplots(figsize=(4.5, 3.5))
    ax.plot(diameters * 1e6, inlet_psd, marker="o", label="Inlet")
    ax.plot(diameters * 1e6, outlet_psd, marker="o", label="Outlet")
    ax.set_xscale("log")
